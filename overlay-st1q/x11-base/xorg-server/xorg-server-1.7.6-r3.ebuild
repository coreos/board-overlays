...
UPSTREAMED_PATCHES=(
	...
	# DRI2SwapBuffers
	"${FILESDIR}/1.7.4-dri2-01_11_09-patchlevel"
	"${FILESDIR}/1.7.6-dri2-allow-multiple-driver-names"
	"${FILESDIR}/1.7.4-dri2-handle-drawable-destruction-properly"
	"${FILESDIR}/1.7.4-add-swap-interval-support"
	)
